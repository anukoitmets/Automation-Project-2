...
describe('Issue create', () => {
  ...
  it.only('Should create an issue (task) and validate it successfully', () => {
    ...
    cy.get('[data-testid="modal:issue-create"]').within(() => {
      ...
      //Use the random data plugin to fill in description with several words
      cy.get('.ql-editor').type(randomSentence);

      //Use the random data plugin to fill in title (1 word)
      cy.get('[data-testid="form-field:title"]').type(randomWord);

      //Issue type dropdown - choose Task
